...
public class Main{
            ...
            switch (opcao) {
                case 1 -> {
                    if(!maquinaBanho.isEmUso()){
                        System.out.print("A maquina não possui nem um pet: ");
                    }else if (maquinaBanho.darBanho()){
                        System.out.print("Pet limpo com sucesso: ");
                    } else {
                        System.out.print("Não ha produtos suficientes na maquina para limpeza do pet: ");
                    }
                }
                case 2 -> {
                ...
                case 4 -> System.out.print("O nível do shampoo é: " + maquinaBanho.getShampoo());
                case 5 -> System.out.print("O nível da agua é: " + maquinaBanho.getAgua());
                case 6 -> {
                    if(maquinaBanho.isEmUso()){
    ...
    public static void exibirMenu() {
        ...
        System.out.println("4 - verificar nivel de shampoo.");
